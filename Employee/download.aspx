<%@ Page Language="C#" AutoEventWireup="true" CodeFile="download.aspx.cs" Inherits="Employee_download" ValidateRequest="false" %>
                  ...
                  <div class="col-lg-3">
                    ...
                    <div class="col-lg-6">
                        ...
                        <table class="table table-bordered table-responsive ">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label4" runat="server" Text="Secret Key"></asp:Label>
                                </td>
                                <td>
                             ...
                             <tr>
                                <td>
                                    <asp:Label ID="Label6" runat="server" Text="Enter Private Key"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Button ID="Button1" runat="server" Text="Download"  CssClass="btn btn-sm btn-success" OnClick="Button1_Click" CausesValidation="false" />
                                </td>
                            </tr>
                        </table>
