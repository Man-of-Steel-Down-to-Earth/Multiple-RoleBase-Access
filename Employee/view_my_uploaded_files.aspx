<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_my_uploaded_files.aspx.cs" Inherits="Employee_view_my_uploaded_files" %>
                            ...
                            <asp:View ID="View1" runat="server">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover" OnRowCommand="GridView1_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="discription" HeaderText="About" />
                                        <asp:BoundField DataField="extension" HeaderText="File type" />
                                        <asp:BoundField DataField="date" HeaderText="Upload date" />
                                        <asp:TemplateField HeaderText="Privacies">
                                            <ItemTemplate>
                                                <asp:BulletedList ID="BulletedList1" runat="server">
                                                </asp:BulletedList>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Add/Remove Roles">
                                            <ItemTemplate>
                                                <asp:Button ID="Button3" runat="server" Text="Add More Roles" CssClass="btn btn-sm btn-success" CommandArgument='<%# bind("fname") %>' CommandName="add" />
                                                <asp:Button ID="Button4" runat="server" Text="Remove Roles" CssClass="btn btn-sm btn-primary" CommandArgument='<%# bind("fname") %>' CommandName="remove" />
                                                <br    <br />   <br />
                                                <asp:Button ID="Button6" runat="server" CommandArgument='<%# bind("fname") %>' Text="Delete File" CssClass="btn btn-sm btn-danger form-control" CommandName="del" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
...
<%--<asp:DataList ID="DataList1" runat="server" CssClass="table table-bordered table-hover table-responsive" OnItemDataBound="DataList1_ItemDataBound" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" Width="2000px">
                                    ...
                                    <SelectedItemStyle BackColor="#738A9C" Font-Bold="True" ForeColor="#F7F7F7" />
                                           ...
                                           <br />
                                           <asp:DataList ID="DataList1" runat="server" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" CssClass="table table-bordered table-hover table-responsive" GridLines="Horizontal" OnItemDataBound="DataList1_ItemDataBound" Width="2000px">
                                               <AlternatingItemStyle BackColor="#F7F7F7" />
                                               <FooterStyle BackColor="#B5C7DE" ForeColor="#4A3C8C" />
                                               <HeaderStyle BackColor="#4A3C8C" Font-Bold="True" ForeColor="#F7F7F7" />
                                               <ItemStyle BackColor="#E7E7FF" ForeColor="#4A3C8C" />
                                               <ItemTemplate>
                                                   <table class="table table-bordered table-hover table-responsive">
                                                       <tr>
                                                           <td>
                                                               <asp:CheckBox ID="CheckBox1" runat="server" />
                                                               <asp:Label ID="Label5" runat="server" ForeColor="Black" Text='<%# bind("role") %>'></asp:Label>
                                                           </td>
                                                           <td>
                                                               <asp:DataList ID="DataList2" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" CssClass="table table-bordered table-hover table-responsive" GridLines="Both">
                                                                   <FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510" />
                                                                   <HeaderStyle BackColor="#A55129" Font-Bold="True" ForeColor="White" />
                                                                   <ItemStyle BackColor="#FFF7E7" ForeColor="#8C4510" />
                                                                   <ItemTemplate>
                                                                       <table class="table table-bordered table-hover table-responsive">
                                                                           <tr>
                                                                               <td>
                                                                                   <asp:CheckBox ID="CheckBox2" runat="server" />
                                                                                   <asp:Label ID="Label6" runat="server" ForeColor="Black" Text='<%# bind("sub_main_role") %>'></asp:Label>
                                                                                   <br />
                                                                                   <asp:Label ID="Label80" runat="server" Font-Size="X-Large" ForeColor="Black" Text='<%# bind("priority") %>' Visible="False"></asp:Label>
                                                                               </td>
                                                                               <td>
                                                                                   <asp:DataList ID="DataList3" runat="server">
                                                                                       <ItemTemplate>
                                                                                           <asp:CheckBox ID="CheckBox3" runat="server" />
                                                                                           <asp:Label ID="Label7" runat="server" ForeColor="Black" Text='<%# bind("sub_role") %>'></asp:Label>
                                                                                           <asp:Label ID="Label8" runat="server" ForeColor="Black" Text='<%# bind("Priority") %>' Visible="false"></asp:Label>
                                                                                       </ItemTemplate>
                                                                                   </asp:DataList>
                                                                               </td>
                            ...
                            <asp:View ID="View3" runat="server">
                              <div class="container">
                                  <div class="row">
                                      <div class="col-lg-2"></div>
                                       <div class="col-lg-10">
                                           <asp:GridView ID="GridView2" runat="server" CssClass="table table-bordered table-active" AutoGenerateColumns="False" OnRowCommand="GridView2_RowCommand">
                                               <Columns>
                                                   <asp:TemplateField>
                                                       <ItemTemplate>
                                                   ...
                                                   <asp:BoundField DataField="roles" HeaderText="Assigned Role" />
                                                   <asp:TemplateField>
                                                       <ItemTemplate>
                                                           <asp:Button ID="Button5" runat="server" CommandArgument='<%# bind("p_id") %>' Text="Click To Remove" CssClass="btn btn-sm btn-danger" />
                                                       </ItemTemplate>
                                                   </asp:TemplateField>
                                               </Columns>
                                           </asp:GridView>
...
<%--                            <asp:Button ID="Button2" runat="server" Text="Privacy" CssClass="btn btn-sm btn-success" OnClick="Button2_Click" />--%>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <br />
                            <br />
                            <asp:Button ID="Button1" runat="server" Text="Back"  CssClass="btn btn-sm form-control btn-success" OnClick="Button1_Click"/>
                        </div>
                    </div>
