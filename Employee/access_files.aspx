<%@ Page Language="C#" AutoEventWireup="true" CodeFile="access_files.aspx.cs" Inherits="Employee_access_files" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class=" text-center">
                            <asp:Label ID="Label2" runat="server" Text="ACCESS FILES" ForeColor="#000099" Font-Size="Large" ></asp:Label>
                        </div>
                        <br />
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-reponsive" OnRowDeleting="GridView1_RowDeleting" >
                              <Columns>
                                ...
                                <asp:BoundField DataField="owner_name" HeaderText="Owner Name" />                                <asp:BoundField DataField="fname" HeaderText="File Name" ItemStyle-BackColor="#99ff99" ItemStyle-ForeColor="#000000" >
<ItemStyle BackColor="#99FF99" ForeColor="Black"></ItemStyle>
                                  </asp:BoundField>
                                <asp:BoundField DataField="discription" HeaderText="Discription" />
                                <asp:BoundField DataField="date" HeaderText="Date " />
                                  <asp:TemplateField HeaderText="Download">
                                      <ItemTemplate>
                                          <asp:Button ID="Button1" runat="server" Text="Download" CssClass="btn btn-sm btn-success" CommandName="delete" />
                                          <br />
                                          <br />
