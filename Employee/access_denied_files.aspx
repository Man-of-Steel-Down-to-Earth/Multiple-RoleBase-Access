<%@ Page Language="C#" AutoEventWireup="true" CodeFile="access_denied_files.aspx.cs" Inherits="Employee_access_denied_files" %>
                    ...
                    <div class="col-lg-12">
                        ...
                        <br />
                          <div class=" text-center">
                            <asp:Label ID="Label2" runat="server" Text="ACCESS DENIED FILES" ForeColor="#cc0000" Font-Size="Large" ></asp:Label>
                        </div><br />
                        

                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-reponsive" OnRowDeleting="GridView1_RowDeleting" >
                              <Columns>
                                <asp:BoundField DataField="fid" HeaderText="#"  Visible="false" />
                                <asp:BoundField DataField="owner_name" HeaderText="Owner Name" />
                                <asp:BoundField DataField="fname" HeaderText="File Name" ItemStyle-BackColor="#ff99cc" ItemStyle-ForeColor="#000000" >
<ItemStyle BackColor="#FF99CC" ForeColor="Black"></ItemStyle>
                                  </asp:BoundField>
                                <asp:BoundField DataField="discription" HeaderText="Discription" />
                                <asp:BoundField DataField="date" HeaderText="Date " />
                                  <asp:TemplateField HeaderText="Request">
                                      <ItemTemplate>
                                          <%--<asp:Button ID="Button1" runat="server" Text="Send Request" CssClass="btn btn-sm btn-danger" CommandName="delete" />--%>
                                          <br />
                                          <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-sm btn-danger" CommandName="delete" >Send Request</asp:LinkButton>
                                          <br />
                                          <asp:Label ID="Label1" runat="server" Text='<%# bind("fname") %>' Visible="False"></asp:Label>
                                                                                    <asp:Label ID="Label2" runat="server" Text='<%# bind("owner_name") %>' Visible="False"></asp:Label>
