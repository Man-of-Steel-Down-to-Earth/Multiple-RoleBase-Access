<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approved_files.aspx.cs" Inherits="Employee_approved_files" %>
		...
		<!-- /banner-text -->
		   <div class="ban-inner-content text-center">
			   <ol class="breadcrumb justify-content-center">
					...
					<li class="breadcrumb-item active">ApprovedFiles</li>
				</ol>
			</div>
		<!-- //banner-text -->
	</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class=" text-center">
                            <asp:Label ID="Label2" runat="server" Text="APPROVED FILES" ForeColor="#cc0000" Font-Size="Large" ></asp:Label>
                        </div>
                        <br />
                        

                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-reponsive" OnRowDeleting="GridView1_RowDeleting" Visible="False" >
                              <Columns>
                                ...
                                <asp:BoundField DataField="date" HeaderText="Upload Date " />
                                  <asp:BoundField DataField="request_date" HeaderText="Requseted Date " />
                                    <asp:BoundField DataField="app_or_rej_date" HeaderText="Accepted/Rejected Date " />

                                  <asp:TemplateField>
                                      <ItemTemplate>
                                          <asp:Label ID="Label3" runat="server" Text="Label" Visible="false"></asp:Label>

                                         <asp:Button ID="Button2" runat="server" Text="Download" CssClass="btn btn-sm btn-success" CommandName="delete" Visible="false" />

                                          <br />
                                          <br />
                                          <asp:Label ID="Label1" runat="server" Text='<%# bind("fname") %>' Visible="False"></asp:Label>
                               <asp:Label ID="Label2" runat="server" Text='<%# bind("request_st") %>' Visible="False"></asp:Label>
                        ...
                        <asp:Label ID="Label4" runat="server" Text="No files" Visible="false"></asp:Label>
                     ...
                     <div class="col-lg-12">
                          <div class=" text-center">
                            <asp:Label ID="Label5" runat="server" Text="APPROVED FILES [employee not present]" ForeColor="#cc0000" Font-Size="Large" ></asp:Label>
                        </div>
                        <br />
                         <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-reponsive" OnRowDeleting="GridView2_RowDeleting" Visible="true" >
                              <Columns>
			...
			<div class="row footer-top">
				<div class="col-lg-3 footer-grid-w3ls">
					<div class="footer-title">
						<h3>About Usllis quis ac lectus. lac inia eget consectetur sed, convallis at
							tellus. Nulla porttitor accumsana tincidunt.
						 class="social-icon footer text-left mt-4">
