<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_files.aspx.cs" Inherits="CEO_view_files" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered  table-condensed" BorderColor="#6699FF" BorderStyle="Solid"  BorderWidth="5px" >
                              <Columns>
                             ...
                             <asp:BoundField DataField="owner_name" HeaderText="Owner Name" />
                                ...
                                <asp:BoundField DataField="date" HeaderText="Upload Date" />
                                 <asp:TemplateField HeaderText="Privacies Assigned To">
                                      <ItemTemplate >
                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          <br />
                                         &nbsp;&nbsp;&nbsp; 
                                          <table class="auto-style1">
                                              <tr>
                                                  <td>&nbsp;</td>
                                                  <td>
                                                      <asp:BulletedList ID="BulletedList1" runat="server" BulletStyle="Square" CssClass="table  table-reponsive" ForeColor="#800000">
                                                      </asp:BulletedList>
                                                  </td>
                                              </tr>
                                          </table>
